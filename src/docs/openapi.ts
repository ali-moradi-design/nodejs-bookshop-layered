...
export const openApiSpec = {
  ...
  "title": "Bookstore API",
  "version": "2.0.0",
  "description": "Layered N-tier bookstore API (Express + Mongoose): JWT auth (Bearer header or httpOnly cookies), RBAC, cart, favorites, discounts, uploads, admin dashboard. Business routes under /api/v1. Cookie-based clients must send credentials (fetch credentials: include) and CORS_ORIGIN must be an explicit frontend origin — not *."
},
  servers: [
  {
