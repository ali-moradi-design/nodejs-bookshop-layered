import type { Permission, CreatePermissionInput, UpdatePermissionInput } from '@app-types/permission';
import type { Role, CreateRoleInput, UpdateRoleInput } from '@app-types/role';
